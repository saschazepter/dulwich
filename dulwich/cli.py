...
class AutoFlushTextIOWrapper:
    ...
    def __init__(self, stream: TextIO, auto_flush: bool) -> None:
        """Initialize the wrapper.

        Args:
            stream: The stream to wrap
            auto_flush: Whether to flush after each write operation
        """
        self._stream = stream
    ...
    def env(
        ...
        """
        return cls(stream, _should_auto_flush(stream, env))
...
class AutoFlushBinaryIOWrapper:
    ...
    def __init__(self, stream: BinaryIO, auto_flush: bool) -> None:
        """Initialize the wrapper.
